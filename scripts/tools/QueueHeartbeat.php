 ...
 *
 * Job action used to add heartbeat task (\oat\taoScheduler\scripts\tools\HeartbeatTask) to each task queue configured
 * in tao
 *
...
class QueueHeartbeat extends AbstractAction
{
    ...
    {
        $taskId = \common_Utils::getNewUri();
        $callbackTask = new CallbackTask($taskId, $this->getOwner());
